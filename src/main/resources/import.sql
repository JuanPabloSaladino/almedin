...
INSERT INTO almedin.turno (cancelado, ocupado, fechaInicio, fechaCreacion, id, profesional_id, socio_id, hash, motivoDeConsulta)
VALUES (0, 0, '2024-06-08 12:15:00.000000', '2024-06-08 11:50:00.000000', 2, 1, 2, '6e3c7c5b-b024-5e96-bd46-7635f8e1fb46', 'Motivo de la consulta del turno 2');

INSERT INTO almedin.turno (cancelado, ocupado, fechaInicio, fechaCreacion, id, profesional_id, socio_id, hash, motivoDeConsulta)
VALUES (0, 0, '2024-06-08 12:30:00.000000', '2024-06-08 11:55:00.000000', 3, 2, 3, '7f4d8d6c-c135-6f07-cd57-8746g9f2gc57', 'Motivo de la consulta del turno 3');

INSERT INTO almedin.turno (cancelado, ocupado, fechaInicio, fechaCreacion, id, profesional_id, socio_id, hash, motivoDeConsulta)
VALUES (0, 0, '2024-06-08 12:45:00.000000', '2024-06-08 12:00:00.000000', 4, 3, 1, '8g5e9e7d-d246-7g18-de68-9857h0g3hd68', 'Motivo de la consulta del turno 4');
...
VALUES ('Contenido de la receta 1', '2024-06-08 12:00:00.000000', 1, 'a1b2c3d4-e5f6-7890-ghij-klmnopqrstuv', 1, 1, 1);

-- Receta 2
INSERT INTO almedin.receta (contenido, fechaCreacion, id, hash, turno_id, profesional_id, socio_id)
VALUES ('Contenido de la receta 2', '2024-06-08 12:15:00.000000', 2, 'b2c3d4e5-f678-90gh-ijkl-mnopqrstuvwx', 2, 1, 2);

-- Receta 3
INSERT INTO almedin.receta (contenido, fechaCreacion, id, hash, turno_id, profesional_id, socio_id)
VALUES ('Contenido de la receta 3', '2024-06-08 12:30:00.000000', 3, 'c3d4e5f6-7890-ghij-klmn-opqrstuvwxyz', 3, 2, 3);

-- Receta 4
INSERT INTO almedin.receta (contenido, fechaCreacion, id, hash, turno_id, profesional_id, socio_id)
VALUES ('Contenido de la receta 4', '2024-06-08 12:45:00.000000', 4, 'd4e5f678-90gh-ijkl-mnop-qrstuvwxyzaa', 4, 3, 1);
